...
- Протестируйте вашу реализацию, запустив `MainArray.main()`: в IDEA слева на полях зеленая стрелка.
- Протестируйте вашу реализацию интерактивно с помощью `MainArrayOldTest.main()`.
